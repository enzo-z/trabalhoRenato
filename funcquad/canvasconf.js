...
function drawParabola(r1, r2, vx, vy, delta, numeros){ //ALERTA DE GAMBIARRA
    c.beginPath();
    ...
    //Se tem duas raizes reais: (Não é gambiarra)
    if (delta > 0){
